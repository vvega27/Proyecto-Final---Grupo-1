        ...
        def menu3():
            ...
            if op3 == 1:
                ...
                def menu3a():
                    ...
                    print("Para ver nuestros planes de viaje elija una opción:\n\n",
                        "1-Ver paquetes Avis.\n",
                        "2-Ver paquetes American Airlines.\n",
                        "3-Ver paquetes TicaBus.\n",
                        "4-Ver paquetes AirCanada.\n",
                        "5-Salir al menu principal.\n")
            
                    op3a= int(input("Escribe un número y pulsa enter: "))

                    if op3a == 1:

                        def mostrarinfo():
                    
                            file=open("listaAvis.txt","r")
                            avis=file.read()
                            print("Los Paquetes con Avis son los siguientes: \n",avis)
                            file.close()
